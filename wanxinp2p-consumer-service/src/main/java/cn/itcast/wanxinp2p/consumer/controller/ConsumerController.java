...
@RestController
@Api(value = "ConsumerController", tags = "Consumer", description = "用户服务API")
...
//		return result>0?RestResponse.success():RestResponse.validfail(result.toString());
	...
	@ApiOperation("批量插入")
	@PostMapping(path = "/listInsert")
	@Override
	public RestResponse listInsert(@RequestBody List<ConsumerRegisterDTO> listConsumerRegisterDTO) {
		
		return consumerService.listInsert(listConsumerRegisterDTO);
	}
